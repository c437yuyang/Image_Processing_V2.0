...
{
	int thresh = getGlobalBasicThresh(src, w, h);
	binThresh(src, w, h, dst, thresh);
}

#pragma region 使用map版本的OTSU deprecated
...
int Threshold::getGlobalBasicThresh(const unsigned char * src, const int w, const int h)
{
...
int Threshold::getOTSUThresh(const unsigned char * src, const int w, const int h)
{
...
void Threshold::OTSU(const unsigned char * src, const int w, const int h, unsigned char * dst)
{
	int thesh = getOTSUThresh(src, w, h);
	binThresh(src, w, h, dst, thesh);
}
